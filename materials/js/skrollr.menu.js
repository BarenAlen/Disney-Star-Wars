...
(function(document, window) {
    ...
    var MENU_MOBILE_OFFSET_ATTR = 'data-mobile-menu-offset';
    ...
    */
    var handleLink = function(link, fake) {
        ...
        if(menuTop !== null) {
            ...
            if (_skrollrInstance.isMobile()) {
                var mobileMenuOffset = scrollTarget.getAttribute(MENU_MOBILE_OFFSET_ATTR);
                if (mobileMenuOffset !== null) {
                    menuOffset = mobileMenuOffset;
                }
            }
